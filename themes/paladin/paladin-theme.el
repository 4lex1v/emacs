;;; paladin-theme.el --- Emacs 24 theme with a dark background.
...
(deftheme paladin "Paladin color theme for Emacs")
...
(let* ((class '((class color) (min-colors 89)))
       ...
       (bg1     (blend "#eee8d5" "#eabc71" 0.98))
       (bg2     (blend "#d9d3c2" "#e3ceab" 0.98))
       (bg3     (blend "#c4bfaf" "#c7b597" 0.98))
       (bg4     (blend "#afab9d" "#a69982" 0.98))
       
       ;; (fg1     (blend "#002b36" (temp bg1 "#ff0000") (temp 0.96 0.98)))
       ;; (fg2     (blend "#183944" (temp bg2 "#ff0000") (temp 0.96 0.98)))
       ;; (fg3     (blend "#2b4852" (temp bg3 "#ff0000") (temp 0.96 0.98)))
       ;; (fg4     (blend "#3e5861" (temp bg4 "#ff0000") (temp 0.96 0.98)))
       ...
       (keyword (blend red fg1 0.60))
       (str     (blend green fg1 0.55))
       (comment (blend "#93a1a1" fg1 0.99))
  ...
  (custom-theme-set-faces
   ...
   `(region                              ((,class (:background ,comment :foreground ,bg1)))) 
   ...
   `(mode-line-inactive                  ((,class (:foreground ,bg1 :background ,fg4 :box nil))))
   ...
   `(helm-selection                      ((,class (:background ,fg3 :foreground ,bg1)))) ;; Used to highlight the line in helm buffers
...
(provide-theme 'paladin)

;;; paladin-theme.el ends here
