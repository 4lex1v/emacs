...
(load (expand-file-name "oldstuff/foundation" user-emacs-directory))

;; Vendor packages
(use-package dash
  :github magnars
  :config
  (use-package s :github magnars)
  (use-package f :github rejeep))

(use-package diminish :github myrjola)
...
(use-package foundation
  ...
  (use-package exec-path-from-shell
    ...
    :github purcell/exec-path-from-shell 
...
;   :github emacsmirror/hideshowvis 
...
;   :init
;   (use-package seq :github NicolasPetton )
...
;   :github emacsmirror/centered-cursor-mode 
;   :init
